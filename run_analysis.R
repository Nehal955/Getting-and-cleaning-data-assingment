unzip(zipfile="./getdata_projectfiles_UCI HAR Dataset",exdir="./data")
unzip(zipfile="./getdata_projectfiles_UCI HAR Dataset",exdir="./midtermdata")
...
list.files("C:/Users/sonic/Documents/Getting and cleaning  data/midtermdata")
